...
GRAPH_SPECS: dict[str, GraphSpec] = {
    ...
    "imu": GraphSpec(
        eyebrow="IMU · Pitch", title="L vs R pitch angle", ds="ds2",
        y_unit="Pitch (°)", x_unit="Time (s)",
        y_ticks=["+20", "+10", "0", "−10", "−20"],
        x_ticks=["0", "2", "4", "6", "8"],
        paths=[
            PathSpec(_LA, 1.8, "L_Pitch", "M48,100 C70,70 92,40 114,50 C136,60 158,130 180,140 C202,150 224,90 246,60 C268,50 290,110 312,140 C332,150 354,100 376,70 C394,55 402,80 408,100"),
            PathSpec(_RA, 1.8, "R_Pitch", "M48,110 C70,90 92,70 114,78 C138,88 158,120 180,126 C204,132 224,100 246,82 C268,75 290,108 312,128 C332,136 354,108 376,88 C394,78 402,90 408,102"),
        ],
    ...
    "imu_avg": GraphSpec(
        ...
        x_ticks=["0", "25", "50", "75", "100"],
        paths=[
            PathSpec(_LA, 1.8, "L_Pitch", "M48,100 C70,70 92,40 114,60 C138,80 158,130 180,140 C202,140 224,90 246,60 C268,50 290,110 312,140 C332,140 354,100 376,70 C394,55 402,80 408,100"),
            PathSpec(_RA, 1.8, "R_Pitch", "M48,110 C70,90 92,70 114,78 C138,88 158,120 180,126 C204,132 224,100 246,82 C268,75 290,108 312,128 C332,136 354,108 376,88 C394,78 402,90 408,102"),
        ],
        summary=[("ROM L", "38.4°"), ("ROM R", "37.1°"), ("asym", "3.4%")],
    ),
    "cyclogram": GraphSpec(
        eyebrow="Phase portrait", title="L-vs-R pitch cyclogram", ds="ds2",
        y_unit="R pitch (°)", x_unit="L pitch (°)",
